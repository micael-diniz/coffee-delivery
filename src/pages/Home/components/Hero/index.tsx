...
export function Hero() {
  return (
    <section className={`relative flex justify-between py-[9.2rem]`}>
      ...
      <div
        className={`containerArea flex w-full justify-center lg:justify-between`}
      >
        <article className="max-w-[58.8rem]">
          ...
          <div className="flex flex-col justify-between gap-y-[2rem] sm:flex-row">
        ...
        <img
          ...
          alt=""
          className={`2lg:max-w-none hidden max-w-[40rem] lg:inline-block`}
        />
      </div>
    </section>
  )
